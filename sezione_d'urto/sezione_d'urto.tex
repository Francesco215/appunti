...
\begin{document}
	...
	\section{Sezione d'urto differenziale}
		...
		Questo torna al livello intuitivo perchè se la sezione d'urto è l'area all'interno del quale c'è interazione tra proiettile e bersaglio, allora nel caso dell'interazione eletromagnetica deve fare infinito visto che il campo elettrico di una carica si estende all'infinito, anche se diventa via via più debole.\newline
