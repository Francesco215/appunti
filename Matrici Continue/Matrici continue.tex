...
\begin{document}
	...
	\section{Trasformata di Furiè}
		...
		Non essendoci stavolta un valido motivo per escludere le funzioni periodiche che hanno la frequenza che non sia un multiplo di $1/T$ possiamo prenderci la libertà di prenderle tutte. Di conseguenza segliamo come base $\{M(x,y_0)=e^{ixy_0}\,|\,y_0 \in \rm I\!R \}$.\newline
